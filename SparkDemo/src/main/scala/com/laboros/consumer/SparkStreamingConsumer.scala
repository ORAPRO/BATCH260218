...
object SparkStreamingConsumer {
  def main(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf().setMaster("local[2]").setAppName("NetworkWordCountStreaming")
